        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="py-12 md:py-20">
            ...
            <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
              <h2 className="h2 mb-4">Follow set cardio workouts or build custom workouts with spotify tunes to match your effort tempo</h2>
            {/* Items */}
            <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
              ...
              <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
                ...
                <h4 className="h4 mb-2">Set Workouts</h4>
                <p className="text-lg text-gray-400 text-center">For Running, Biking, Eliptical, or even custom cardio workouts</p>
              </div>
              ...
              <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
                ...
                <h4 className="h4 mb-2">Custom Workouts</h4>
                <p className="text-lg text-gray-400 text-center">A Simple UI that allows you to build custom workouts for any activity type both for distance and time intervals! Just enter the required time/distance and pace/effort level, and the app will build a playlist perfectly designed for the effort level you are targeting!</p>
              </div>
              ...
              <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-blocks]">
                ...
                <h4 className="h4 mb-2">Outdoor Mode</h4>
                <p className="text-lg text-gray-400 text-center">Use offline mode, so that you can run to your favourite tunes</p>
              </div>
              ...
              <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-blocks]">
                ...
                <h4 className="h4 mb-2">Upload to Strava</h4>
                <p className="text-lg text-gray-400 text-center">Upload your workout data to Strava to share all of your data with your friends</p>
              </div>
